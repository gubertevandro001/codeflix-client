...
export default function Header() {
    ...
    return (
        <header className={`${isScrolled && 'bg-black'} isSrolled && 'bg-clack'} fixed top-0 z-50 flex w-full items-center justify-between transition-all px-4 py-4 lg:px-10 lg:py-6`}>
