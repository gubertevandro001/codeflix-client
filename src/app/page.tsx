...
export default function Home() {
  return (
    <div className='relative bg-gradient-to-b h-screen overflow-hidden lg:h-[140vh]'>
      <Header />
      <main className='relative pb-24 pl-4 lg:pl-16'>
        ...
        <p className='text-shadow-md max-w-xs text-xs md:max-w-lg md:text-lg lg:max-w-2xl'>
          Geralt of Rivia, a solitary monster hunter, struggles to find his place in a world where people often prove
